...
%>
<br><br><br><br><hr>
<b><font color="#00CC33"><%out.println("DATA INSERTED");%></font></b>
<br><br>
<input type="submit" name="back" value="BACK" style="width: 80; height: 20; border: 1px solid #0000FF" onClick="check()">
<hr>
</center>
</form>
</body>
