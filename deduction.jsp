...
<body bgcolor="#FFFFCC">
<form action="./deduct" name="deduct1">
<center>
...
<table>
<tr>
<td>Year</td><td><input type="text" name="year" value="<%=year%>" readonly="yes"></td>
<td></td>
<td>Month</td><td><input type="text" name="month" value="<%=month%>" onBlur="checkmonth()" readonly="yes"></td>
</tr>
<tr>
<td>Employee Code</td><td><select name="empid" readonly="yes">
<option><%=rs.getString(1)%></option>
</select></td>
<td></td>
<td>Employee Name</td><td><input type="text" name="empname" value="<%=rs.getString(2)%>" readonly="yes"></td>
</tr>
<tr>
<td>Department Code</td><td><input type="text" name="deptcode" value="<%=rs.getString(8)%>" readonly="yes"></td>
<td></td>
<td>Designation Code</td><td><input type="text" name="desncode" value="<%=rs.getString(6)%>" readonly="yes"></td>
</tr>
<tr>
<td>Other Earnings-I</td><td><input type="text" name="oe1" onBlur="checkoe1()"></td>
<td></td>
...
<input type="submit" value="DELETE" style="width:80;height:20; border:1px solid #0000FF" onClick="delded1()">
