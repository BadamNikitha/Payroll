...
<td></td>
<td>Month</td><td><input type="text" name="month" onBlur="checkmonth()"></td>
</tr>
<tr>
<td>Employee Code</td><td><select name="empid" onBlur="check()">
<option>--</option>
<%while(rs.next())
{%>
...
<input type="submit" value="DELETE" style="width:80;height:20; border:1px solid #0000FF" onClick="delded()">
<input type="submit" value="BACK" style="width:80;height:20; border:1px solid #0000FF" onclick="history.back()">
</td>
</tr>
</table>
</center>
