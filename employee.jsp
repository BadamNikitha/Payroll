...
<td></td>
        <td><font color="#800000" size=""><b>Grade Code</b></font><font color="#800000">&nbsp;</font></td>        <td><select name="grade">
            <% while(rs1.next())
{%>
...
<tr>
<td>
<input type="submit" value="SAVE" style="width: 80; height: 20; border: 1px solid #0000FF" onClick="empsave()">
<input type="reset" value="ADDNEW" style="width: 80; height: 20; border: 1px solid #0000FF">
<input type="submit" value="DELETE" style="width: 80; height: 20; border: 1px solid #0000FF" onClick="delete1()">
